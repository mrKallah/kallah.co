...
class_one = "kw"                                # the name of the class that is correlated to the file name identifier
...
def main():
	...
	utils.print_prediction(data, 1, x, y_true, session, y_pred_cls, class_one, class_zero, image_shape, num_channels, plt_show)
